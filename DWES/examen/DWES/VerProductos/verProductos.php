...
require "basedatos.php";
    ...
    function filtrarProducto($sql, $producto, $dbh){
        //try{
            ...
            echo "<div id=\"producto\"><p>Nombre: ". $row->titulo . "</p><p>Precio: ".$row->precio."€</p><a href=\"verProductos.php?accion=mostrarmas&id=".$row->idAnuncio."\">Ver mas</a><div id=\"cambiarIcono\"><i class=\"far fa-heart fav sinMarcar\"></i></div></div>";
            }
            /*
            if($valor){
                $listaAnuncios = Array();
