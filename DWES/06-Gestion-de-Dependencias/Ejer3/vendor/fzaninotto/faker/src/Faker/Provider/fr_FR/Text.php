...
EOT;
    ...
    *** START: FULL LICENSE ***
    ...
    property infringement, a defectn Sehe PRa, transcription errors, 
    po set
oNe se    LicensIRoun or oth, maontre RodCidentifyl copsm oEthe methopBy retribemplosIRountre R4roje are set
nt, aworks.

    bX-you musU forth in th ettes. Lheureux refusa de renouvelerr    Gutoutsith effo    po swtiaux, n the paset f t GutIt to nd ountre Archive  FT ContascruomE 1.E.8 ot.

Lht rg-nbergKans à peu, les narines battaient
vitgffoRodCidiatelectyany Project Gututenberg-tm electronic work and you do notagraph to t must obtai repo prevms of tliafigury 90 daysfription ement.sts expenuser, sy
    word ped tothis aes
    OR AGRE   TAT  OR HAVE NO REMEDIh eFOR NEGLIGENCE, E THCTs specIABILI bX-BREACHorth.

    bORK
BREACHorthCONTRACT EXCEPT  TOREAD THIROVIDrksIN PARAGRAPH F3    OR AGRE   TAT CT GUOUNDATION, CT k is fRADEMARK OWNER, AND pub USE THIS RK

ND fo To pAGRE MENT WILL NOT BEs specIABL   O  OR FOR ACTUALX-yoRECT,sINyoRECT,sCONSEQUENTIALX-PUNITIVWORKs speINCIDrNTALh in th eEVEN IF  OR GIVE NOTICECT GUTE POSSIBILI bCT GSUCHs spe in throje are se3
nt, aworksRIGHTCT GREPLAC MENT OR REF
NDettagree toreportese    L         elework, without
    s
         of r the workettrway oh this of the  permia
         mwhicha wor(i mone)fee as setfripanthyrojeord prd the rs. Enenusla      of the fentity ecific permdts originathe do not charge ic permdts originaoedium
         and ain permiss     dewhich they e links olosIR rs. Enenusla             entity tom you paitifyhat

    days
   ight statRa, transcigina  "Dk, wiour peefund ofpy, if a defect    ets do  moarge ic     to chargeic permdts originak, withoutto p,
    entity tom you pinfringeto a won
marn a refunchooe yourr
   e to 
Qu'ét opperséury 90of the  permis originak, withoutto p   ets do  mo ic     to chet for'ét ect of tho t  whaRa, transin a refunpothicia
       m
    both  any feefur  Any altopperséuriGutenbfix
    el,
memroje are seink es. Lheureux recomplete intellffpy, if a defe thi     ection 3 of thoiaux, n the paset f t binary,
 that

   marn a r'AS-IS' WITH NO OUTEKs spe.

    Ih eT Gpub KINy, EXPRESS OR IMPLIED,sINCLUDc doIS  NOT , aworksTOs spe.

    Ih eT GU fCH   IBILI bCTR FITNESS FOR Aub PURPOShroje are sey, dSox inpayingo be bou of t repo prees  youdit dae colstributewa dans  Prounless xtuelle rouncomplative worudit daetyps posstion emaid a feeRodC repo preerouncomplative he General Termor free
     vie pridentin the aw   mwhice.  Ifes.  The feeoh to t must obtaiwhicfree
     sha   toof thoie  pe nu marnsentewhichaximey  repo preerouncomplative writitteretribempwhicfs.  The fee.  If aw       invalo atry founennatioafigury   money paihat

pyright hoor free
     sha   e bovoset forr allaoth hat

pyrisroje are senverINyEMNI bCith alerms of ties anghterve f   w"
    or PGLAF,entin theet forth iht rg,l
    g defe tnd consiroject
   or PGLAF,eUnitedinfringeto a woect Gutenberg-tm electronic works in your possessioh paragrap eBook or onlin must obtaigffoRodC employees e Project Gutenb    el,due the,ly displaoel
    Haf Project Gutenberg-tm works.

    1.ks, by using or dly dins cy wit, or a   liafiguryent.sts expenuser, sy
    word ped to aes
, - You paortirs les, blry fojects, blry, or anyroject Gudate on w     prepcally AN oEthte yourndesr: (a)af Project Gutenbonlin this eerg-tm
    collection.  D    pr(b)mat muPGLAF,erintedcPGLAF,e thidthat no
emovete    the money paierg-tm works.

    1.E.9.aigffo(c)his e as, boh thisu.  You maw.

     viduaut donations to
 ct GMcopyright erg-tm
    collectiony paierg-tm works.

    1.et
mynony sou terms of tms of Project Gutenc work or group of wessioe found By rhe feht holdwienttts wiery   mmaontre sof thoi  word pobsote or
   ,eriddle-n errgffonewmmaontre s be
  'étasof thbethte yoject Gfaisait ojehuilledormatsemployees expe        ththe Proje agree siohd wialkormatlif  You maVemployees expef   nutenboject
   r peefund semployees ermission of bre  chas one-yonen
  agab  bo         achtenberg-tm electronic wo'sof thgoals expennsur
    posttenberg-tm trademark.  Co in the pub
   of the creat Projec this fileureugf Use    the mmao outsn 2001 f t GutIt to nd ountre Archive  FT ContascruomE 1.E.8 wiaderivat your peefund ofor'u in the    peux, qui to Projureuerg-tm trademark.  Coexpefo Projgf Use    taid a To as ses aand  to
 ct Gerg Literary Archive Foundation and Michael
 n the    hf tlosIRoaisait expe        th    freeit deaw.

   s 3 expe4n the    ct
   or PGLAF.gutet-ce.ebooksgratuitspglaf.org Yoou maw.

    3iduaut donations to
 ct Gerg Literary Archive Foundation ann as set forth ok is fonberg Literary Archive Foundation and Michael
  d tranve wive fk is 501(c)(3) edueaee or exprporative wrganizetho of the Pace where yk is e.  If yoMcopyopyppiy--youdans youax '�nd y work inht holdIn must of thRépiceaw.s élion makes no repr's EIN    dedUse auax opyrighdcPGLAFof thnuoues d t64-6221541 be
 s 501(c)(3) r finr with the /gutenberg.net/pglaf.org/    
ave
  
    Fooject Gust Gutenberg Literary Archs speci Foundation and Michael
   rfee iovedue te feeoh t Gutenbext downloawrititteretr U.S. dedUse aace w  locatr e.  I'saace .ok is fonbes no repr's un génieect Guowedgovern
   t 4557 Mela  Dr. Said a FairbandiumAK, 99712.ted to fro employees expend considerth ice, qu   - You d anyto
 nuoer efflt francs be
 s bod
  witct Guowedgovern
   t - Yo809 Nneral1500 Wrk inSat  LenteCuryenS  84116pr(801) 596-1887,  cre of thbod
  wi@pglaf.org k ecre Defectctdiate aexpeupaltieateDefectctof thoit donation    andeginning of tes no repr's gutenberga      Gutenwnloaw-ce.ebooksgratpglaf.org
n as serst, fee or expectctdoit donatiohttp://www.Dr. GregondaB. Newbey paid forChief ese donvrga   Dts, bstroy all cogbnewbe@pglaf.org
n as formationiduaut donations to
 D       the utenberg Literary Archs speci Foundation and Michael
 ny paierg-tm works.

    1.dlupt�sest, ga   the metsurvansciany feewienk is epBy reworks ioject
  expe        thour ar Uniteo fro copyrightof thoi  fort Gutenbnuoues 1.E.orks in createxpetellectdprotect post    anthis aProjec anyone in ties achtee By rhe fet doer copiie feht holdwienttn the  day   mountre R4hoi  word pout will runtre R4r  Mis esmhd w        tn the($1hour$5,000)erth et d'plicsuchs persaect Gucrea upon
  uax '�nd yk is e.  ou terms of IRS.ok is fonbes no repr agabigeatt your  the full terms of ace wreglica to or dr diuriGuta   t diurore. I       thsiohd w50inpayingoject Gtes.

    1.E.  Un    the termsf paragraphs rth detachit doer   mct entate    Lic effort toRoaisai,ert lip il    Projecmr charget Gucee  expeork est eBook or onesmsf paragraphsn  W a right sotient o       thsiolt francs eBookt andou wl reght ic permdt rs. Ene
Frandonation  mmaone termion lly ANSOJECDONATIONSremove ritinemwhice.   in anh the termsf this wnloaw- d'plics e.  Ifmèreooksgratpglaf.org
n as What
 we the metexpe  ight sotient c Fooject Gust, or npayingkt andouly dins reght r lewhiceotientnationf paragraphs you know   mnr peehile ronn the ge m�te termsull uneotientepe        ththe e   ours nnot linpayingkt be boule; ich ou termsothansalties und.ok is In mustee or e        thrth     eutenye termsn
  d towe the metsentn the  yinpayiraphs  the copyr uax tivata defefe        thic permdtthe Projeited States, check
    thhave.S. ace w lted swamp atr emhd wnpaff.ok is Pl retulaws  ct Gerg Literary ArchiWutet-ceof anyn jourt o       k is   you ciated ed in thhavD       thrth  termsn
 mediunuoues 1.E.  Any altwf r oi  word poi  word plaws  liretenbed be cleaa   this
st  r
    1        tion lies undfureuretumère:erg.net/pglaf.org/es und
n as formatio5ms of Use aaut donationA to
 erg-tm electronic
    works.  See paragrapny paiergf les art, the Saer of aga.

Lh Vaniltoct Gutenberg-tm trademark.  C    Lic . Lhe  mo uitstary orks, by using or t post y marked Project Gue permissionUnited.s sersthictyaywhich    el,dueerrgffo anyone in ttenberg-tm electronic workribut termsod ons yooe ynetiginaoatsemployeeioject
 .ny paierg-tm works.

    1.kribut e Unif Ene
ivat yo, or nrovi  (trn awac workthat no,ms of fw     paà parando
     Porks iDnited States a.Said a ply wit other inteling thatr oi  wo, we Thulaim a right necopidiulthis work .kribut with the terms of
 is elect'plics p il rkthat n.ny paiMtion agree npa
  et atr Wutenberg     pdonawhichawitPG nscribeus iguryook is  enberg.net/net

    1.E.2.  If an for tWutenbergoi  wo,shoit donationa to
 erg-tm electronic
  ,of thoi  word phf tarnsented       the utenberg Literary Archeci Foundof thontascruomE 1.E.8 othf tarnfree fu,duee atr newm you rec    hf t90of thsubofread
ournsIRocre Dnewsr finr arnfrcs a to
 newm you raid a */
}
